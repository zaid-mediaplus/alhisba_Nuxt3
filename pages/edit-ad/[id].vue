...
import videoIcon from "/icons/vidio-icon.svg";
import documentIcon from "/icons/document.svg";
const attatchmentImages = ref([photoIcon, videoIcon, documentIcon]);
const items = ref([
  { id: 1, icon: "/icons/photo.svg", title: "أضف إلى حد 9 صور" },
  { id: 3, icon: "/icons/vidio-icon.svg", title: "أضف فيديو " },
  { id: 2, icon: "/icons/document.svg", title: "أضف مستند" },
]);
const taps = ref([
  {
    id: 1,
...
import sellIcon from "/icons/property.svg";
import rentIcon from "/icons/rent.svg";
import wantedSellIcon from "/icons/property.svg";
import wantedRentIcon from "/icons/rent.svg";
